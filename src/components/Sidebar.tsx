...
export default function Sidebar({ navItems, activeView, onNavigate, liveOn, onToggleLive, open, onClose }: SidebarProps) {
  return (
    <>
      {open && (
        <div
      ...
      <div
        className={`fixed inset-y-0 left-0 z-40 flex w-[240px] flex-none flex-col gap-7 bg-[#030712] p-4 py-6 transition-transform duration-200 md:static md:z-auto md:translate-x-0 ${
